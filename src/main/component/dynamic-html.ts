...
export class DynamicHtml {
  ...
  private slot : ViewSlot | null;
  public bindingContext : Object | null;
  public overrideContext : OverrideContext | OverrideContext | null;
  ...
  protected contextChanged(newValue : any, _? : any) : void {
